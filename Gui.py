...
class Game_GUI:
    ...
    def __init__(self, maze, items):
        ...
        if platform.system() == "Windows":
            self.img_player = pygame.image.load(r"ressource\MacGyver.png")
            self.background = pygame.image.load(r"ressource\Background.png")
            self.img_walls = pygame.image.load(r"ressource\Wall.png")
            self.img_npc = pygame.image.load(r"ressource\Gardien.png")
            self.item_1 = pygame.image.load(r"ressource\baton.png")
            self.item_2 = pygame.image.load(r"ressource\pipe.png")
            self.item_3 = pygame.image.load(r"ressource\potion.png")
            self.img_end_game = pygame.image.load(r"ressource\youdied.png")
            self.img_win_game = pygame.image.load(r"ressource\youwin.png")
        else:
            self.img_player = pygame.image.load("ressource/MacGyver.png")
            self.background = pygame.image.load("ressource/Background.png")
            self.img_walls = pygame.image.load("ressource/Wall.png")
            self.img_npc = pygame.image.load("ressource/Gardien.png")
            self.item_1 = pygame.image.load(r"ressource/baton.png")
            self.item_2 = pygame.image.load("ressource/pipe.png")
            self.item_3 = pygame.image.load("ressource/potion.png")
        ...
        self.sprite_items = [WallSprite(self.item_1), WallSprite(self.item_2),
                             WallSprite(self.item_3)]
    ...
    def on_loop_game(self):
        ...
        while self.running:
            ...
            if self.new_position != self.old_position:
                ...
                self.new = self.maze.get_symbol_at_position(self.new_position)
                if self.maze.true_or_false_pos(self.new_position) is True:
                    self.new_symbol = self.new
                else:
                    self.new_symbol = None
                    self.rollback()

                # If wall is true the player move back position
